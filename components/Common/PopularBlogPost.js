    ...
    <>
      <div className="blog-area pt-70">
              ...
              <div className="single-blog">
                <div className="blog-image blog_first">
                  <Link href="/blog">
                    <a>
                      <img
                        src="/images/blog/ragzon-ecommercewebsitetrend (1).webp"
                        alt="image"
                      />
                    </a>
                  </Link>
              ...
              <div className="single-blog">
                <div className="blog-image">
                  <Link href="/blog">
                    <a>
                      <img
                        src="/images/blog/ragzon-Metaverse (1).webp"
                        alt="image"
                      />
                    </a>
                  </Link>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-blog">
                <div className="blog-image">
                  <Link href="/blog">
                    <a>
                      <img src="/images/blog/ragzon-blog-3.webp" alt="image" />
                    </a>
                  </Link>
                </div>
        ...
        <div className="blog-shape-1">
          <img src="/images/blog/ragzon-shape-1.webp" alt="image" />
        </div>
        <div className="blog-shape-2">
          <img src="/images/blog/ragzon-shape-2.webp" alt="image" />
        </div>
      </div>
