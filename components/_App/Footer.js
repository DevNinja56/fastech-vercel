                        ...
                        <div className="col-lg-4 col-sm-6 col-md-6">
                            <div className="single-footer-widget">
                                <div className="widget-logo">
                                    <Link href="/">
                                        <a>
                                            <img className='logo_main' src="/images/logo.png" alt="image" />
                                        </a>
                                    </Link>
                                </div>
                                <p>Fastech offers software development consulting services for businesses, startups, and enterprises. Partner with a reliable software development company to scale up your engineering capacity.</p>
                        ...
                        <div className="col-lg-3 col-sm-6 col-md-6">
                            <div className="single-footer-widget">
                                ...
                                <ul className="widget-social">
                                    <li>
                                        <a href="https://www.facebook.com/theafastech" target="_blank">
                                    ...
                                    <li>
                                        <a href="https://www.linkedin.com/company/thefastech/" target="_blank">
                ...
                <div className="copyright-area">
                    <div className="container">
                        <div className="copyright-area-content">
                            <p>
                                Copyright © {currentYear} All Rights Reserved | Developed by <span className='footer_name'>Fastech</span>
                            </p>
                        </div>
                    </div>
                </div>
