                        ...
                        <div className={classOne} id="navbarSupportedContent">
                            <ul className="navbar-nav m-auto">
                                <li className="nav-item">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li className="nav-item">
                                            <Link href="/details-services">
                                                <a onClick={e => {
                                                    ...
                                                    <img src="/images/web-design_development.svg" className="icons_img_meg_menu" />Web Design & Development</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/index-2">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/nav/SQA.svg" className="icons_img_meg_menu" />Dev Ops</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/index-3">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Software Project Management</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/index-4">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Mobile App Development</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/index-5">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />UI/UX Design</a>
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link href="/index-5">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Software Quality Assurance</a>
                                            </Link>
                                        </li>
                                ...
                                <li className="nav-item">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li className="nav-item">
                                            <Link href="/industryDetail">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />E-Commerce</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/about-us-2">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Food & Grocery</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/features">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Features One</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/features-2">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />On Demand Services</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/testimonials">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Healthcare</a>
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link href="/testimonials">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Fintech</a>
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link href="/testimonials">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Travel & Tourism</a>
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link href="/testimonials">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Education</a>
                                            </Link>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li className="nav-item">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li className="nav-item">
                                            <Link href="#">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Mern Stack</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="#">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />React js</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/services-3">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Reactive Native</a>
                                            </Link>
                                        </li>
                                    ...
                                    <ul className="dropdown-menu menu_small">
                                        <li className="nav-item">
                                            <Link href="/team-member">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Blog</a>
                                            </Link>
                                        </li>
                                    ...
                                    <ul className="dropdown-menu menu_small">
                                        <li className="nav-item">
                                            <Link href="/case-study">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />About Us</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/case-study-2">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Careers</a>
                                            </Link>
                                        </li>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/case-study-details">
                                                <a onClick={toggleNavbar} className="nav-link">
                                                    <img src="/images/icons.svg" className="icons_img_meg_menu" />Portfolio</a>
                                            </Link>
                                        </li>
                                    </ul>
                                </li>
