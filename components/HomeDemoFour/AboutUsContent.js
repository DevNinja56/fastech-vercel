                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6">
                                <div className="experiences-item">
                                    <div className="experiences-content">
                                        <div className="tag">
                                            <img src="/images/favicon.png" className='fav_img' alt="image" />
                                        </div>
                                        <h3>Over 12 Year Professional Experiences</h3>
                                        <p>Best Strategic planning dolor sit amet consectetur adipiscing elit. Scelerisque amet odio velit  auctor. nam elit nulla eget sodales dui pulvinar.</p>
                                    </div>

                                    <div className="experiences-inner-content">
                                        <img src="/images/experiences/img1.png" alt="image" />
                                        <p>Best Strategic planning dolor sit amet consectetur adipiscing elit. risque amet odio velit eu auctor. Aliquet nam elit nulla eget sodales.</p>
                                    </div>

                                    <div className="experiences-inner-content">
                                        <img src="/images/experiences/img2.png" alt="image" />
                                        <p>Ozen digital agency for your start  planning dolor sit amet consectetur adipiscing elit. Scelerisque amet odio velit eu auctor.</p>
                                    </div>
                            ...
                            <div className="col-lg-6">
                                <div className="experiences-image">
                                    <img src="/images/developmentimage.png" className='dev_img' alt="image" />
                                </div>
                            </div>
                        </div>
                    </div>
