                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <div className="experiences-item">
                                ...
                                <div className="experiences-inner-content">
                                    <img className='exp_img' src="/images/experiences/icon1.svg" alt="image" />
                                    <p>Our staff augmentation model is intended to help companies find the right skills for their project.</p>
                                </div>

                                <div className="experiences-inner-content">
                                    <img className='exp_img' src="/images/experiences/icon2.svg" alt="image" />
                                    <p>The project-based model is designed to help you get your product built from ideation to deployment by a team of expert software engineering consultants.</p>
                                </div>

                                <div className="experiences-inner-content">
                                    <img className='exp_img' src="/images/experiences/icon3.svg" alt="image" />
                                    <p>Our team of developers is highly qualified and dedicated to delivering quality development services to clients.</p>
                                </div>
                        ...
                        <div className="col-lg-6">
                            <div className="experiences-image">
                                <img className='pl-5' src="/images/Engagement-Models (1).png" alt="image" />
                            </div>
                        </div>
                    </div>
                </div>
