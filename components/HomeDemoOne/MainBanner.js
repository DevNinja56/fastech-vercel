                        ...
                        <div className="col-lg-5 col-md-12">
                            <div className="main-banner-content">
                                ...
                                <ScrollAnimation animateIn="fadeInLeft" delay={100} animateOnce={true}>
                                    ...
                                    <h1 className='main_heading_step_animation'>We Build Powerful Digital Solutions for
                                        <p />
                                        <span
                                            className="txt-rotate"
                                            data-period="2000"
                                            data-rotate='[ "Businesses", "Innovators", "Startups", "Online Stores", "Entrepreneurs" ]'></span>
                                    </h1>
