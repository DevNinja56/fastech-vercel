                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="single-cases">
                                ...
                                <div className="cases-content">
                                    ...
                                    <p>It gives you easy access to search thousands
                                        of dogs, puppies, cats, kittens, rabbits, horses and
                                        other pets for sale and adoption.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="cases-image">
                                ...
                                <div className="cases-content">
                                    ...
                                    <p>An online education portal with study material, quizzes, and mock exams for students.</p>
                                </div>
                            ...
                            <div className="single-cases">
                                ...
                                <div className="cases-content">
                                    ...
                                    <p>On demand ride service app
                                        is an awesome cheap rideshare cab
                                        pp and service platform that connects
                                        you with dedicated and independent
                                        ocal taxi drivers, cab drivers.</p>
                                </div>
                            </div>
                        </div>
