                ...
                <div className="single-cases">
                  <div className="cases-image">
                    <Link href="/case-study-details">
                      <a>
                        <img
                          src="/images/cases-study/cases-1.jpg"
                          alt="image"
                        />
                      </a>
                    </Link>
                ...
                <div className="single-cases">
                  <div className="cases-image">
                    <Link href="/case-study-details">
                      <a>
                        <img
                          src="/images/cases-study/cases-2.jpg"
                          alt="image"
                        />
                      </a>
                    </Link>
                ...
                <div className="single-cases">
                  <div className="cases-image">
                    <Link href="/case-study-details">
                      <a>
                        <img
                          src="/images/cases-study/cases-3.jpg"
                          alt="image"
                        />
                      </a>
                    </Link>
                ...
                <div className="single-cases">
                  <div className="cases-image">
                    <Link href="/case-study-details">
                      <a>
                        <img
                          src="/images/cases-study/cases-4.jpg"
                          alt="image"
                        />
                      </a>
                    </Link>
                ...
                <div className="single-cases">
                  <div className="cases-image">
                    <Link href="/case-study-details">
                      <a>
                        <img
                          src="/images/cases-study/cases-5.jpg"
                          alt="image"
                        />
                      </a>
                    </Link>
                ...
                <div className="single-cases">
                  <div className="cases-image">
                    <Link href="/case-study-details">
                      <a>
                        <img
                          src="/images/cases-study/cases-6.jpg"
                          alt="image"
                        />
                      </a>
                    </Link>
