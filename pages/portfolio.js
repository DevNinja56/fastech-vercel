...
import { BlogArray_1, BlogArray_2, BlogArray_3, BlogArray_4, BlogArray_5, BlogArray_6, BlogArray_7, BlogArray_8, BlogArray_9 } from '../components/TechComponent/TechData';
            ...
            <div className="container">
                <div className="row Tech_wrapper">
                    <div className="col-12 text-center">
                        <h1>Our <span>Awesom</span> WorkSpace</h1>
                    </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog">
                                <div className="blog-image blog_first">
                                    <Link href="#">
                                        <a>
                                            <img src="/images/blog/ecommercewebsitetrend (1).jpg" alt="image" />
                                        </a>
                                    </Link>
                                </div>
