                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://magictask.io/">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web1.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://www.jobgeniedevs.com/">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web2.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://bitnob.com/">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web3.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://imaginovation.net/">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web4.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://modjen.com/password">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web5.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="#">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web6.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://modjen.com/">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web7.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://staging.properfans.com">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web8.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://wehelprx.com">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web9.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://shopperhits.com">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web10.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://www.beautflo.com">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web11.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://gosnabby.com">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-web12.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://play.google.com/store/apps/details?id=com.fivesechealth">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-mob1.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://apps.apple.com/us/app/rentberry-apartment-rentals/id1388237443">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-mob2.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://play.google.com/store/apps/details?id=com.potsworkprovider">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-mob4.png"
                              alt="image"
                            />
                          </a>
                        </Link>
                    ...
                    <div className="single-projects-box">
                      <div className="projects-image">
                        <Link href="https://play.google.com/store/apps/details?id=com.camelan">
                          <a target="blank">
                            <img
                              src="/images/new-portfolio/ragzon-mob3.png"
                              alt="image"
                            />
                          </a>
                        </Link>
